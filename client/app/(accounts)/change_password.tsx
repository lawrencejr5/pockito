    ...
    <SafeArea>
      <View style={{ flex: 1, padding: 10, backgroundColor: COLORS.sec_color }}>
        ...
        <View style={{ marginTop: 30, paddingHorizontal: 10 }}>
          <TextInput placeholder="old password" style={styles.text_input} />
          <TextInput placeholder="new password" style={styles.text_input} />
          <TextInput placeholder="confirm password" style={styles.text_input} />
